window.FC_GATE1_QUESTIONS = [
  {
    ...
    question: 'What is your role in Operation First Contact?',
    answers: [
      'Translate everything the alien says',
      'Give the alien the correct English answer',
      'Help the alien understand how English works',
      'Correct every grammar error immediately'
    ],
    correct: 2,
    explanation: 'Your job is to help the alien understand how English works so its communication can improve step by step.'
  },
  {
    id: 2,
    level: 1,
  ...
  },
  {
    ...
    points: 200,
    category: 'TEACH → BUILD → TEST',
    question: 'The alien now understands that table is a noun. Which teaching move BEST builds the same word-function pattern?',
    answers: [
      '“Run is a verb because it shows an action.”',
      '“Fear is also a noun because it names an idea.”',
      '“The is a determiner because it identifies a noun.”',
      '“Slowly is an adverb because it modifies a verb.”'
    ],
    correct: 1,
    explanation: 'Build means giving another example of the same concept. Fear is another noun, and the explanation focuses on the noun’s function.'
  },
  {
    id: 5,
    level: 2,
  ...
  },
  {
    id: 10,
    level: 4,
    levelLabel: 'CHALLENGING',
    clearance: 'HIGH COMPLEXITY',
    points: 400,
    category: 'TRANSFER OF UNDERSTANDING',
  ...
  },
  {
    ...
    question: 'You ask, “Give me one noun and tell me what it names.” The alien responds, “We repair ship tomorrow.” Before deciding what grammar to reteach, what should you determine FIRST?',
    answers: [
      'Whether ship needs an article',
      'Whether the alien understood what you were asking it to do',
      'Whether tomorrow is functioning as an adverb',
      'Whether the sentence contains a complete subject and verb'
    ],
    correct: 1,
    explanation: 'Before diagnosing the grammar, first determine whether the alien understood the task. A response can contain grammatical information without actually answering the prompt.'
  },
  {
    id: 12,
    level: 4,
  ...
  },
  {
    ...
    level: 5,
    levelLabel: 'EXPERT',
    clearance: 'OMEGA ANALYSIS',
    points: 500,
    category: 'INTEGRATED WORD FUNCTION',
    question: 'Consider: “The cautious human moved cautiously toward the ship.” Which analysis is completely correct?',
    answers: [
      'cautious = adjective; cautiously = adverb; toward = preposition; the = determiner',
      'cautious = adverb; cautiously = adjective; toward = conjunction; the = pronoun',
      'cautious = adjective; cautiously = adjective; toward = preposition; the = article',
      'cautious = noun; cautiously = adverb; toward = conjunction; the = determiner'
    ],
    correct: 0,
    explanation: 'Cautious modifies human, cautiously modifies moved, toward shows direction, and the introduces or identifies the noun.'
  },
  {
    id: 14,
    level: 5,
